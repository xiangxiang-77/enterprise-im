...
- File/image/message advanced product features from the full PRD are not all production-complete in this submit slice.
...
4. Complete advanced message operations: edit history, recall audit, forwarding policy, favorites, reactions, read/unread member drilldown, and burn-after-reading policy.
